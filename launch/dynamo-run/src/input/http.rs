...
/// Spawns a task that watches for new models of the give model_type in etcd at network_prefix,
...
async fn run_watcher(
    ...
    tracing::info!("Watching for remote {model_type} model at {network_prefix}");
